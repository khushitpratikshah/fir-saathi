...
import { ArrowRight, CheckCircle2, CircleAlert, ClipboardCheck, Clock3, Copy, FileKey2, FileText, ShieldCheck } from "lucide-react";
...
export default function CitizenStatus() {
  ...
  const citizenAccessCode = getCitizenAccess(publicId);
