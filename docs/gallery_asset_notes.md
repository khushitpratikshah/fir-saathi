...
The current README already embeds the evidence board and language-picker screenshot. A gallery section should use repository-hosted PNG assets with descriptive captions, preferably cropped/padded to a consistent 3:2 ratio and each below 5 MB.
